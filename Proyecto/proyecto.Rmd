...
Los resultados obtenidos por cada una de las tres variantes se pueden ver en la siguiente tabla:

|   Número de capas     | $E_{CV}$ |
|:---------------------:|:--------:|
| Una capa              | 1.6667   |
| Dos capas             | 5.4545   |
| Tres capas            | 1.5151   |
...
De esta tabla se extrae que la regresión logística es más que suficiente para predecir con alta fiabilidad nuevos datos; de hecho, parece realizar un mejor ajuste que los modelos no lineales. Para confirmar esto, vamos a analizar también las curvas _ROC_ y el área debajo de las mismas.
