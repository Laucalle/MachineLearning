...
En primer lugar, mediante la función \texttt{regsubsets} seleccionaremos las características con las que vamos a predecir la variable de respuesta. Esta selección de características se puede realizar de varias maneras diferentes:
